...
questions = [
    ...
    {
        "question": "Реклама, телебачення, кіно, тощо повинно бути виключно українською мовою",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    {
        "question": "Військовозабов'язані чоловікі, які втекли з України повинні повернутися, щоб захищати свою Батьківщину",
        "effect": {
            "econ": -7,     // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": -1,     // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
    ...
    // },
    {
        "question": "Усім було б краще, якщо б усі українці перейшли на українську мову",
        "effect": {
            "econ": 0,      // ПОЛІТИКА     (зрада/перемога)
            "dipl": 0,      // ВПЛИВ        (русофілія/українство)
            "govt": 0,      // ДИПЛОМАТІЯ   (євроатлантізм/самостійність)
